...
namespace Pensees.Charon.Migrations
{
    ...
    [Migration("20200408023811_Add_OptionalMember_To_Tenant")]
    partial class Add_OptionalMember_To_Tenant
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pensees.Charon.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pensees.Charon.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Pensees.Charon.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Pensees.Charon.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Pensees.Charon.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Pensees.Charon.Authorization.Roles.Role", b =>
                {
                    b.HasOne("Pensees.Charon.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("Pensees.Charon.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Pensees.Charon.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
